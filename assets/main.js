	...
	// Container: background.
		(function() {
			...
			new slideshowBackground('background', {
				...
				images: [
					{
						src: 'assets/images/background-4afb57dd.webp',
						position: 'top left',
						motion: 'down',
						speed: 2,
					...
					{
						src: 'assets/images/background-fca5f0c6.webp',
						position: 'center',
						motion: 'in',
						speed: 1,
					...
					{
						src: 'assets/images/background-1d82f158.webp',
					...
					{
						src: 'assets/images/background-5ab18195.webp',
						position: 'center',
						motion: 'none',
						speed: 2,
					...
					{
						src: 'assets/images/background-76b36ab5.webp',
						position: 'center',
						motion: 'in',
						speed: 2,
					...
					{
						src: 'assets/images/background-e7aa2ffd.webp',
						position: 'center',
						motion: 'in',
						speed: 2,
					...
					{
						src: 'assets/images/background-976648f2.webp',
						position: 'center',
						motion: 'out',
						speed: 2,
					...
					{
						src: 'assets/images/background-cd21823b.webp',
						position: 'left',
						motion: 'right',
						speed: 1,
					...
					{
						src: 'assets/images/background-6cda4671.webp',
						position: 'right',
						motion: 'left',
						speed: 2,
					...
					{
						src: 'assets/images/background-bd4ae7e9.webp',
						position: 'right',
						motion: 'left',
						speed: 2,
					...
					{
						src: 'assets/images/background-ff935909.webp',
						position: 'bottom',
						motion: 'up',
						speed: 2,
					...
					{
						src: 'assets/images/background-cf491dd2.webp',
						position: 'center',
						motion: 'down',
						speed: 2,
					...
					{
						src: 'assets/images/background-51a201d8.webp',
						position: 'center',
						motion: 'none',
						speed: 2,
